...
<body>
            ...
            <ul class="links">
                ...
                <li>
                    <button class="dropdown-btn" href="#">
                        ...
                        <span class="link-name active">Faculty</span>
                        <img class="arrow" src="images/arrow.svg" alt="" />
                    </button>
                    <div class="dropdown-menu">
                        <a href="add_faculty.php">Add Faculty</a>
                        <a href="all_faculty.php">All Faculty</a>
                        <a class="active" href="edit_faculty.php">Edit Faculty</a>
                        <a href="#">Status</a>
    ...
    <section class="dashboard-container">
        ...
        <div class="form-container">
            <form class="form" method="post" action="functions/update.php?id=<?php echo $faculty_id; ?>">
            <input type="hidden" name="employee_id" value="<?php echo $faculty_id;?>"> 
