...
function clearAllActiveClasses() {
    const statusSteps = [
        { id: 'stat-1', separator: 'separator-1' },
        { id: 'stat-2', separator: 'separator-2' },
        { id: 'stat-3', separator: 'separator-3' },
        { id: 'stat-4', separator: null }
    ];
    ...
    statusSteps.forEach(step => {
        ...
        if (separatorElement) {
            ...
            separatorElement.style.backgroundColor = ''; // Reset background color
        }
    });
}
...
function updateProgressStatus(applicationStatus) {
    ...
    const statusSteps = [
        { id: 'stat-1', separator: 'separator-1', status: 'PENDING' },
        { id: 'stat-2', separator: 'separator-2', status: 'APPROVED' },
        { id: 'stat-3', separator: 'separator-3', status: 'APPROVED' },
        { id: 'stat-4', separator: null, status: 'REJECTED' }
    ];
