        ...
        <ul class="links">
            ...
            <li>
                <a class="s-link <?= $active == "profile" ? "active" : "" ?>" href="about_department.php">
                    ...
                    <span class="link-name <?= $active == "profile" ? "active" : "" ?>">About</span>
                </a>
            </li>
            ...
            <li>
                <a class="s-link <?= $active == "leave" ? "active" : "" ?>" href="all_leave.php">
                    <svg class="icon <?= $active == "leave" ? "active" : "" ?>" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="500" zoomAndPan="magnify" viewBox="0 0 375 374.999991" height="500" preserveAspectRatio="xMidYMid meet" version="1.0">
                        <defs>
                            <clipPath id="6325d10b93">
                                <path d="M 0 43.125 L 375 43.125 L 375 287 L 0 287 Z M 0 43.125 " clip-rule="nonzero" />
                            </clipPath>
