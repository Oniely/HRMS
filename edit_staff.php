...
$employee_id = $_GET["id"];
$query = mysqli_query($conn, "SELECT employee_tbl.*, resedential_address_tbl.barangay as res_barangay, resedential_address_tbl.municipality_city as res_city, resedential_address_tbl.province as res_province, permanent_address_tbl.barangay as per_barangay, permanent_address_tbl.municipality_city as per_city, permanent_address_tbl.province as per_province,
 place_of_birth_tbl.barangay as pob_barangay, place_of_birth_tbl.municipality_city as pob_city, place_of_birth_tbl.province as pob_province, 
 fathers_name.fname as father_fname, fathers_name.mname as father_mname, fathers_name.lname as father_lname, mothers_name.fname as mother_fname, mothers_name.mname as mother_mname, mothers_name.lname as mother_lname FROM employee_tbl 
        ...
        <div class="form-container">
            <form class="form" method="post" action="functions/staff/update.php?id=<?php echo $employee_id; ?>">
                ...
                <div class="flex">
                    ...
                    <label>Employee ID
                        <input type="text" placeholder="faculty ID" name="faculty_id" value="<?php echo $row['employee_id'] ?>">
                    </label>
                </div>
                <div class="flex">
                    <label>Date of Birth
