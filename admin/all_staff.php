        ...
        <div class="table-buttons">
            ...
            <button>
                <svg id="arrow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <path d="M 284.238281 172.824219 L 119.457031 8.042969 C 111.414062 0 98.371094 0 90.324219 8.042969 C 82.5 16.085938 82.5 28.914062 90.324219 36.957031 L 240.761719 187.390625 L 90.324219 337.824219 C 82.5 345.871094 82.5 358.914062 90.324219 366.957031 C 98.371094 375 111.414062 375 119.457031 366.957031 L 284.457031 201.957031 C 292.5 193.914062 292.5 180.871094 284.238281 172.824219 Z M 284.238281 172.824219 "
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        <tr>
                            ...
                            <td class='action'>
                                ...
                                <a class="delete-btn"
                                   href="functions/staff/delete.php?id=<?php echo $row['employee_id']; ?>">
                                    <div>
