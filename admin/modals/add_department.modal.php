<div id="admin_modal_container" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-[1000] justify-center items-center w-full md:inset-0 h-full max-h-full bg-white bg-opacity-40 shadow-sm">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div id="admin_modal" class="relative bg-white rounded-lg shadow">
            ...
            <!-- Modal body -->
            <form action="/HRMS/admin/functions/department/create_department_account.php" method="POST" class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="privilage" class="block mb-2 text-sm font-medium text-gray-900">Department</label>
                        <select id="privilage" name="department" class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2">
