...
if (isset($_POST['add']) && $_SERVER['REQUEST_METHOD'] === "POST") {
       ...
       if ($result->num_rows > 0) {
              ...
              redirect('/hrms/admin/all_faculty.php');
       }
       resetForm();
       $conn->close();
}
              ...
              <form class="f-container" method="post" enctype="multipart/form-data">
                     <div class="f-section">
                            ...
                            <div class="f-inputs px-0">
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="fname" id="fname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="mname" id="mname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="lname" id="lname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          ...
                                          pattern="09[0-9]{9}"
                                          maxlength="11"
                                          oninput="validatePhoneNumber(this)" name="contactnumber" id="contactnumber" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          <input type="number" name="height" id="height" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          <input type="number" name="weight" id="weight" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                     ...
                     <div class="f-section mt-20">
                            ...
                            <div class="f-inputs px-0">
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="father_fname" id="father_fname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="father_mname" id="father_mname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="father_lname" id="father_lname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                            ...
                            <div class="f-inputs px-0">
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="mother_fname" id="mother_fname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="mother_mname" id="mother_mname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
                                   ...
                                   <div class="relative z-0">
                                          <input type="text" name="mother_lname" id="mother_lname" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b border-[#9d9d9d] appearance-none text-black focus:outline-none focus:ring-0 peer" placeholder=" " />
